...
const Interface::FunctionInfo FunctionTable[] = {
    ...
    {0x00090002, UpdateStoredAmiiboData, "UpdateStoredAmiiboData"},
    ...
    {0x00130040, OpenAppData, "OpenAppData"},
    {0x00140384, nullptr, "InitializeWriteAppData"},
    {0x00150040, ReadAppData, "ReadAppData"},
    {0x00160242, WriteAppData, "WriteAppData"},
    ...
    {0x001E0040, IsAvailableFontRegion, "IsAvailableFontRegion"},
